...
export function CaseStudyModal({ project, isOpen, onClose }: CaseStudyModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent 
        className="max-w-4xl w-[94vw] max-h-[90vh] p-0 gap-0 rounded-2xl sm:rounded-3xl border border-silver-200 bg-white shadow-2xl focus:outline-none flex flex-col overflow-hidden"
