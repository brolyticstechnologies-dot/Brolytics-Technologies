    ...
    <section className="py-20 bg-white border-b border-silver-100 relative overflow-hidden isolate">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <div className="hidden sm:inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-silver-100/80 border border-silver-200/70 text-silver-600 text-xs font-semibold shrink-0 self-start md:self-auto">
            <Sparkles className="w-3.5 h-3.5 text-primary" />
            <span>100+ Technologies & Frameworks</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {techList.map((tech, i) => (
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-bold text-silver-800 group-hover:text-silver-950 transition-colors truncate">
                {tech}
              </span>
            </div>
          ))}
        ...
        {/* Bottom Banner Strip */}
        <div className="mt-8 p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-silver-50 via-white to-silver-50 border border-silver-200/70 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0 w-full sm:w-auto justify-end">
            <Link
              href="/technologies"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-silver-900 text-white text-xs sm:text-sm font-bold hover:bg-primary transition-colors shadow-xs group"
            >
              <span>Explore all 100+ Technologies</span>
